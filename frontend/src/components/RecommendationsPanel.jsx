...
const RecommendationsPanel = () => {
  const strategicRecommendations = [
    ...
    },
    {
      ...
      "description": "O investimento de R$ 47,21 bilhões na função Transporte é vital para a infraestrutura logística do país. Este valor sustenta a manutenção e expansão de rodovias, ferrovias e portos. A aplicação estratégica desses recursos pode reduzir custos logísticos, aumentar a competitividade dos produtos brasileiros e melhorar a mobilidade da população.",
      "priority": "media",
      "category": "Transporte",
      "investment": "R$ 47.21 bilhões",
      "action": "Priorizar o investimento em projetos de integração de modais (rodoviário, ferroviário e aquaviário) para criar corredores de exportação mais eficientes e reduzir a dependência do transporte rodoviário, diminuindo custos e impacto ambiental."
    },
    {
      "id": 12,
      "title": "Foco em Direitos da Cidadania",
      "description": "O montante de R$ 38,70 bilhões para Direitos da Cidadania financia a proteção de direitos humanos e a promoção da igualdade. Este investimento é fundamental para a defesa de minorias e a garantia de direitos fundamentais. A otimização do seu uso pode fortalecer a democracia e a inclusão social no país.",
      "priority": "media",
      "category": "Direitos da Cidadania",
      "investment": "R$ 38.70 bilhões",
      "action": "Desenvolver campanhas nacionais de conscientização e canais de denúncia mais acessíveis para violações de direitos, utilizando parte dos recursos para fortalecer conselhos tutelares e órgãos de proteção a grupos vulneráveis."
    },
    {
      "id": 13,
      "title": "Desenvolvimento da Agricultura",
      "description": "Com um total de R$ 26,05 bilhões, a função Agricultura é essencial para um dos pilares da economia brasileira. O investimento apoia desde a agricultura familiar até o agronegócio, impactando a segurança alimentar e a balança comercial. O fomento à inovação neste setor pode ampliar a produtividade de forma sustentável.",
      "priority": "media",
      "category": "Agricultura",
      "investment": "R$ 26.05 bilhões",
      "action": "Criar linhas de crédito e assistência técnica focadas em práticas agrícolas sustentáveis e de baixa emissão de carbono, incentivando a recuperação de pastagens degradadas e a adoção de tecnologias de agricultura de precisão."
    },
    {
      "id": 14,
      "title": "Otimização no Setor Legislativo",
      "description": "O investimento de R$ 16,33 bilhões na função Legislativa assegura o funcionamento do Congresso Nacional, assembleias e câmaras municipais. Embora seja um custo para a manutenção da democracia, a busca por eficiência e transparência nos gastos pode aumentar a confiança da população no poder Legislativo.",
      "priority": "baixa",
      "category": "Legislativa",
      "investment": "R$ 16.33 bilhões",
      "action": "Implementar uma plataforma unificada de transparência para todos os níveis do Legislativo, detalhando gastos com pessoal, verbas de gabinete e emendas parlamentares em um formato de dados abertos e de fácil compreensão pelo cidadão."
    },
    {
      "id": 15,
      "title": "Fomento à Ciência e Tecnologia",
      "description": "Os R$ 15,84 bilhões aplicados em Ciência e Tecnologia são o motor para a inovação e o desenvolvimento futuro do país. Este valor, embora modesto, financia pesquisas e bolsas. Um aumento ou otimização deste investimento é crucial para a soberania tecnológica e a competitividade global do Brasil.",
      "priority": "media",
      "category": "Ciência e Tecnologia",
      "investment": "R$ 15.84 bilhões",
      "action": "Concentrar investimentos em áreas tecnológicas estratégicas, como biotecnologia, inteligência artificial e energias renováveis, criando hubs de inovação que conectem universidades, institutos de pesquisa e o setor privado."
    },
    {
      "id": 16,
      "title": "Alavancagem do Urbanismo",
      "description": "O investimento de R$ 8,10 bilhões em Urbanismo impacta diretamente a qualidade de vida nas cidades. Os recursos são destinados a obras de saneamento, habitação e mobilidade urbana. O planejamento integrado desses investimentos é fundamental para o desenvolvimento urbano sustentável e inclusivo.",
      "priority": "media",
      "category": "Urbanismo",
      "investment": "R$ 8.10 bilhões",
      "action": "Direcionar os investimentos para projetos de requalificação de áreas centrais degradadas e para a regularização fundiária em áreas urbanas, promovendo o acesso à moradia digna e melhorando a infraestrutura local."
    },
    {
      "id": 17,
      "title": "Gestão Ambiental Estratégica",
      "description": "O aporte de R$ 7,16 bilhões na Gestão Ambiental é fundamental para a conservação dos biomas brasileiros e a fiscalização de crimes ambientais. Este investimento, apesar de parecer baixo frente à vastidão territorial, é decisivo para a sustentabilidade e a imagem do país no exterior.",
      "priority": "alta",
      "category": "Gestão Ambiental",
      "investment": "R$ 7.16 bilhões",
      "action": "Investir em tecnologias de monitoramento por satélite e em drones para fortalecer a fiscalização contra o desmatamento ilegal e as queimadas, além de ampliar os recursos para as unidades de conservação."
    },
    {
      "id": 18,
      "title": "Desenvolvimento da Indústria",
      "description": "Os R$ 4,88 bilhões destinados à Indústria visam fomentar a competitividade e a inovação no setor secundário. O direcionamento desses recursos pode ajudar a modernizar o parque industrial brasileiro e a gerar empregos de maior qualidade, agregando valor à produção nacional.",
      "priority": "baixa",
      "category": "Indústria",
      "investment": "R$ 4.88 bilhões",
      "action": "Criar um programa de incentivo à digitalização para pequenas e médias indústrias (Indústria 4.0), oferecendo crédito com juros baixos e consultoria para a adoção de automação e processos mais eficientes."
    },
    {
      "id": 19,
      "title": "Foco em Saneamento",
      "description": "O investimento de R$ 3,60 bilhões em Saneamento é crucial para a saúde pública e a preservação ambiental. A universalização do acesso à água tratada e à coleta de esgoto é um dos maiores desafios do país. Mesmo com um valor limitado, projetos bem executados podem transformar a realidade de muitas comunidades.",
      "priority": "alta",
      "category": "Saneamento",
      "investment": "R$ 3.60 bilhões",
      "action": "Fomentar parcerias público-privadas e consórcios intermunicipais para acelerar os investimentos em saneamento básico, priorizando as regiões com os piores indicadores e maior vulnerabilidade social."
    },
    {
      "id": 20,
      "title": "Oportunidade no Setor de Energia",
      "description": "O montante de R$ 3,36 bilhões destinado à Energia apoia a expansão e a diversificação da matriz energética brasileira. Este investimento é estratégico para garantir a segurança energética e impulsionar a transição para fontes mais limpas e renováveis, como a solar e a eólica.",
      "priority": "media",
      "category": "Energia",
      "investment": "R$ 3.36 bilhões",
      "action": "Lançar um programa de incentivos para a instalação de painéis solares em residências de baixa renda e prédios públicos, visando democratizar o acesso à energia limpa e reduzir a demanda sobre o sistema elétrico nacional."
    }
  ];
